...
from agent.tools import arxiv_search, calculator, web_search, generate_movie_query_parameters,call_graphql_api
...
tools = [calculator, generate_movie_query_parameters, call_graphql_api]
